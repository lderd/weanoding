    ...
    <div class="hide-on-small">
      ...
      <div class="tool-wrapper">
        ...
        <div class="button-wrapper">
          <el-button v-if="!state.isLoggedIn" type="primary" @click="clickSignup">회원가입</el-button>
          <el-button v-if="!state.isLoggedIn" type="primary" @click="clickLogin">로그인</el-button>
          <el-button v-if="state.isLoggedIn" type="primary" @click="clickLogout">로그아웃</el-button>
        </div>
      </div>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const state = reactive({
      ...
      isLoggedIn: computed(() => store.getters['root/getIsLogined'])
    })
    ...
    const clickLogout = () => {
      ...
      if(state.isLoggedIn){
        ...
        store.commit('root/setIsLoggedIn', false)
        alert('로그아웃 되었습니다.')
      }
    }
    ...
    return { state, menuSelect, clickLogo, clickLogin, changeCollapse, clickSignup, clickLogout }
  }
}
</script>
<style>
